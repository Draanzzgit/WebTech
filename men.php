...
$query = "SELECT * FROM tb_barang WHERE (category = 'Atasan' OR category = 'Bawahan' OR category = 'Aksesoris') AND gender = 'Laki-laki'";
...
<nav class="navbar bg-body-tertiary fixed-top">
 ...
 <section class="container-fluid banner d-flex align-items-center">
  ...
  <section class="container-fluid py-5">
    <div class="container">
        <h3 class="text-5xl font-bold text-center mb-5 py-5">Bawahan</h3>
